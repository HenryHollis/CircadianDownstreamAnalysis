...
path_to_cyclops_ordering = "/Users/henryhollis/Box Sync/Henry_stuff/AD_project/human_data/Cyclops_folders/training_output/scROSMAP/cogdx_controls/wAD/Astrocytes/TMMs_w_batch/Astro_FiltByEdgeRDefault_OrderedByExcNeuronsErikChenZhangCondBatchCovs3egNoTransferFit/"

#path to normalized counts
path_to_tmm_file = "/Users/henryhollis/Box Sync/Henry_stuff/AD_project/human_data/Cyclops_folders/tmms/scROSMAP/cogdx_controls/EdgeR_filt_normed/Astrocytes_FiltByExprDefault_TMM_combatSeqAdjusted.csv"
...
plot_clock_face(paste0(abs_path, "downstream_output/clock_face_plots/CTL_cyclers.png"),"downstream_output/cosinor_results_CTL.csv", BHQ_cutoff = isCyclingBHQCutoff, amp_ratio_cutoff = 0 )

setwd(path_to_cyclops_ordering)

#for cycling_in_AD.csv
plot_clock_face(paste0(abs_path, "downstream_output/clock_face_plots/AD_cyclers.png"),"downstream_output/cosinor_results_AD.csv", BHQ_cutoff = isCyclingBHQCutoff, amp_ratio_cutoff = 0)
```
